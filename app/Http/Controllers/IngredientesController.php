...
class IngredientesController extends Controller
{
    ...
    {
        return Response::json(Ingredientes::all(), 200);
    }
    ...
    public function uploadAvatar(Request $request, $id) {
        $objectUpdate = Ingredientes::find($id);
        if ($objectUpdate) {
            ...
            if ($validator->fails()) {
                ...
                try {
                    $path = Storage::disk('s3')->put('ingredientes', $request->avatar);
    ...
    {
        $objectSee = Ingredientes::find($id);
        if ($objectSee) {
    ...
    {
        $objectDelete = Ingredientes::find($id);
        if ($objectDelete) {
            try {
